...
export default function ProfileCard({
  ...
  return (
    ...
    >
      ...
      <style>{`
        .pc-wrap:hover .pc-behind-glow, .pc-wrap.active .pc-behind-glow { opacity: 0.55; }
      `}</style>
          ...
          >
            ...
            <div
              style={{
                ...
                filter: 'brightness(0.7) contrast(1.35) saturate(0.35) opacity(0.5)',
            ...
            >
              <img
                className="w-full absolute left-1/2 bottom-[-1px] will-change-transform"
                src={avatarUrl}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <div className="text-[13px] font-medium text-white/90 leading-none">@{handle}</div>
                      <div className="text-[11px] text-white/60 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/10 rounded-lg px-3 py-2 text-[11px] font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 hover:border-white/30 hover:-translate-y-px"
