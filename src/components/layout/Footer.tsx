    ...
    <footer id="contact" className="relative py-16 px-6 border-t border-white/5">
      <div className="max-w-6xl mx-auto text-center">
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <span className="font-mono text-xs uppercase tracking-widest text-zinc-500">{t.footer.sectionId}</span>
        </div>
        <p className="text-violet-400 text-sm font-medium tracking-wider mb-4">{t.footer.label}</p>
